...
LICENSE_FILE = os.path.join(os.path.dirname(os.path.abspath(__file__)), "license.lic")
...
def get_machine_id():
    ...
    unique_parts.append(platform.node())
    unique_parts.append(platform.processor())
